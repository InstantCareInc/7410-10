...
#. Install nRF Connect SDK version 3.1.1
#. Install nRF Connect SDK Toolchain version 3.1.1
#. Open this project folder in Visual Studio Code using the NRF Connect Extension option "Open an existing application"
#. Select the build target correct build target. For this application make sure you have the 7410-10 custom board selected.
